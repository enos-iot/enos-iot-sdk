...
/**
 * @version $Id: EnosTrustManager.java, v 0.1
 *          lvjianwen Exp $
 */
public class EnosTrustManager extends X509ExtendedTrustManager {

    // Root certificate authentication
    private X509TrustManager rootTrusm;

    public EnosTrustManager() throws Exception {
        // CA root certificate can be downloaded from the official website
        InputStream in = EnosTrustManager.class.getResourceAsStream("/sChat.jks");
