...
import com.enosiot.enos.iot_mqtt_sdk.core.internals.constants.DeliveryTopicFormat;
...
import static com.enosiot.enos.iot_mqtt_sdk.core.internals.constants.FeatureType.MEASUREPOINT;
                ...
                if (value.getClass().isArray()) {
                    ...
                    for (int i = 0; i < len; i++) {
                        ...
                        if (objArray[i] instanceof File) {
                            fileUriArray[i] = LOCAL_FILE_SCHEMA + storeFile(key, (File) objArray[i]);
                        }
                    }
