...
import com.enosiot.enos.iot_http_sdk.auth.AuthRequestBody;
import com.enosiot.enos.iot_http_sdk.auth.AuthResponseBody;
import com.enosiot.enos.iot_http_sdk.file.*;
import com.enosiot.enos.iot_http_sdk.progress.IProgressListener;
import com.enosiot.enos.iot_http_sdk.progress.ProgressRequestWrapper;
import com.enosiot.enos.iot_http_sdk.registry.MethodDecoderRegistry;
import com.enosiot.enos.iot_http_sdk.ssl.OkHttpUtil;
...
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.tsl.ModelUpRawRequest;
...
import static com.enosiot.enos.iot_http_sdk.HttpConnectionError.*;
...
public class HttpConnection {
    ...
    private void replyMsg(BaseMqttCommand<?> msg, List<String> pathList, IMqttDeliveryMessage deliveryMsg) throws IOException, EnosException {
     ...
     */
    public AuthResponseBody auth() throws EnosException {
            ...
            try {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (!lastAuthResponse.isSuccess()) {
                        ...
                        throw new EnosException(lastAuthResponse.getCode(), lastAuthResponse.getMessage());
                    }
                ...
                throw new EnosException(e, CLIENT_ERROR);
            } finally {
     ...
     * @throws EnosException
     */
    private <T extends BaseMqttResponse> T publishCall(Call call, IMqttDeliveryMessage request) throws EnosException {
        try (Response httpResponse = call.execute()) {
            ...
            throw new EnosException(SOCKET_ERROR);
        } catch (Exception e) {
     ...
     * @throws EnosException
     */
    private <T extends BaseMqttResponse> Call generatePlainPublishCall(IMqttDeliveryMessage request) throws EnosException {
        checkAuth();
    ...
    private Call generatePublishCall(IMqttDeliveryMessage request,
                                     IProgressListener progressListener) throws EnosException, IOException {
        if (request instanceof BaseMqttRequest &&
    ...
    public RangeFileBody downloadFile(String fileUri, FileCategory category, Long startRange, Long endRange) throws EnosException {
     ...
     * @throws EnosException
     */
    public InputStream downloadFile(String fileUri, FileCategory category) throws EnosException, IOException {
    ...
    public void downloadFileAsync(String fileUri, FileCategory category, IFileCallback callback) throws EnosException {
        downloadFileAsync(fileUri, category, null, null, callback);
    }

    public void downloadFileAsync(String fileUri, FileCategory category, Long startRange, Long endRange, IFileCallback callback) throws EnosException {
        Call call = generateDownloadCall(fileUri, category, startRange, endRange);
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (!response.isSuccessful()) {
                    callback.onFailure(new EnosException(response.code(), response.message()));
                }
    ...
    public String getDownloadUrl(String fileUri, FileCategory category) throws EnosException {
        ...
        try {
            ...
            if (!response.isSuccess()) {
                throw new EnosException(response.getCode(), response.getMessage());
            }
     ...
     * @throws EnosException
     */
    public FileDeleteResponse deleteFile(String fileUri) throws EnosException {
    ...
    public void deleteFileAsync(String fileUri, IResponseCallback<FileDeleteResponse> callback) throws EnosException {
        Call call = generateDeleteCall(fileUri);
    ...
    private Call generateGetDownloadUrlCall(String fileUri, FileCategory category) throws EnosException {
        checkAuth();
    ...
    private Call generateDownloadCall(String fileUri, FileCategory category, Long startRange, Long endRange) throws EnosException {
        checkAuth();
    ...
    private Call generateDeleteCall(String fileUri) throws EnosException {
        checkAuth();
