...
import com.enosiot.enos.iot_mqtt_sdk.message.downstream.device.SubDeviceDisableCommand;
import com.enosiot.enos.iot_mqtt_sdk.message.downstream.device.SubDeviceDisableReply;
import com.enosiot.enos.iot_mqtt_sdk.message.downstream.device.SubDeviceEnableCommand;
import com.enosiot.enos.iot_mqtt_sdk.message.downstream.tsl.*;
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.ResponseCode;
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.register.DeviceRegisterRequest;
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.register.DeviceRegisterResponse;
...
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.tag.*;
...
//                        "new_tag" + new Random().nextInt(100))
    ...
    public static void subDeviceRegister() {
        ...
        DeviceRegisterRequest request = DeviceRegisterRequest.builder()
                .addRegisterInfo(subProductKey, "zscai-sub-device-1", new StringI18n("zscai-sub-device-1"), "zscai-sub-device-1", "+08:00")
                .addRegisterInfo(subProductKey, "zscai-sub-device-2", new StringI18n("zscai-sub-device-2"), "zscai-sub-device-2", "+08:00")
                .addRegisterInfo(subProductKey, "zscai-sub-device-3", new StringI18n("zscai-sub-device-3"), "zscai-sub-device-3", "+08:00")
                .build();
...
//            return null;
    ...
    public static void disconnect() throws EnosException {
        client.disconnect();
