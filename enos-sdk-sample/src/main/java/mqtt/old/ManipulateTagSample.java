...
public class ManipulateTagSample {
    ...
    public static void updateTags(MqttClient client, Map<String, String> tags) throws EnosException {
    ...
    public static void queryTags(MqttClient client) throws EnosException {
    ...
    public static void deleteTags(MqttClient client, List<String> tags) throws EnosException {
