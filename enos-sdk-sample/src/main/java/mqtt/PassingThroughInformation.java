...
import com.enosiot.enos.iot_mqtt_sdk.message.downstream.tsl.ModelDownRawCommand;
import com.enosiot.enos.iot_mqtt_sdk.message.downstream.tsl.ModelDownRawReply;
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.tsl.ModelUpRawRequest;
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.tsl.ModelUpRawResponse;
...
public class PassingThroughInformation {
    ...
    static void sendPassingThroughInformation() throws EnosException, DecoderException {
