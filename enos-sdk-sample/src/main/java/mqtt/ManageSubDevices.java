...
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.register.DeviceBasicInfo;
...
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.topo.TopoAddRequest;
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.topo.TopoAddResponse;
...
public class ManageSubDevices {
    ...
    static void registerDevice() throws EnosException {
    ...
    // Sample: add topology
    static void addTopology() throws EnosException {
    ...
    static void loginSubDevice() throws EnosException {
    ...
    static void postMeasurepointForSubDevice() throws EnosException {
