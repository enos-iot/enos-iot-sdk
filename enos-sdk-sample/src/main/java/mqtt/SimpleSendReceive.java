...
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.tag.TagQueryRequest;
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.tag.TagQueryResponse;
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.tag.TagUpdateRequest;
import com.enosiot.enos.iot_mqtt_sdk.message.upstream.tag.TagUpdateResponse;
...
public class SimpleSendReceive {
    ...
    static void queryDeviceTags() throws EnosException {
    ...
    static void updateDeviceTags() throws EnosException {
        // device tags can be set and viewed on Device Details page in EnOS Console
    ...
    static void queryDeviceAttributes() throws EnosException {
    ...
    static void updateDeviceAttributes() throws EnosException {
        // device attributes are defined in ThingModel, which can be viewed in Model Details page in EnOS Console
    ...
    static void postMeasurepoint() throws EnosException {
    ...
    // Sample: post event
    static void resumeMeasurepoint() throws EnosException {
        // device measurement points are defined in ThingModel, which can be viewed in Model Details page in EnOS Console
    ...
    // Sample: post event
    static void postEvent() throws EnosException {
