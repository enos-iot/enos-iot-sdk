...
public class Config {
    ...
    private Boolean autoLoginSubDevice = true;
    ...
    private Set<DeviceCredential> subDevices = new HashSet<>();
    ...
    public Boolean getAutoLoginSubDevice() {
        return autoLoginSubDevice;
    }

    public Config setAutoLoginSubDevice(Boolean autoLoginSubDevice) {
        this.autoLoginSubDevice = autoLoginSubDevice;
        return this;
    }
    ...
    public SignMethod getSignMethod() {
        return SignMethod.getSignMethod(signMethodName);
    }
